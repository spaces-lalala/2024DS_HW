...
def main():
    ...
    output_files = {
        "insertion_sort": "output_7_insertion_sort",
        "merge_sort": "output_7_merge_sort",
        "quick_hoare": "output_7_quick_hoare",
        "counting_sort": "output_7_counting_sort"
    }
    ...
    # 繪製圖表
    plot_graph(list(output_files.values()), list(cpp_programs.keys()), "graph7.png", missing_points)
