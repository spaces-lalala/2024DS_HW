...
def main():
    ...
    output_files = {
        "quick_merge_1": "./output_6_quick_merge_1",
        "merge_quick_1": "./output_6_merge_quick_1",
        "quick_merge_2": "./output_6_quick_merge_2",
        "merge_quick_2": "./output_6_merge_quick_2",
        "quick_merge_3": "./output_6_quick_merge_3",
        "merge_quick_3": "./output_6_merge_quick_3",
        "quick_merge_4": "./output_6_quick_merge_4",
        "merge_quick_4": "./output_6_merge_quick_4",
        "quick_merge_5": "./output_6_quick_merge_5",
        "merge_quick_5": "./output_6_merge_quick_5"
    }
    ...
    for s in range(1,6):
        for k in range(0, 21):  # 可調整範圍
            ...
            for name, executable in cpp_programs.items():
                ...
                success = run_cpp_program(executable, size, "second", k_value ,s, output_files[name], timeout=3000)
                if not success:
    ...
    for name, output_file in output_files.items():
        ...
        # 繪製圖表
    plot_graph(list(output_files.values()), list(cpp_programs.keys()), "graph_6.png", missing_points)
