...
def main():
    ...
    output_files = {
        "quick_merge_1": "./output_9_quick_merge_1",
        "merge_quick_1": "./output_9_merge_quick_1",
        "quick_merge_2": "./output_9_quick_merge_2",
        "merge_quick_2": "./output_9_merge_quick_2",
        "quick_merge_3": "./output_9_quick_merge_3",
        "merge_quick_3": "./output_9_merge_quick_3",
        "quick_merge_4": "./output_9_quick_merge_4",
        "merge_quick_4": "./output_9_merge_quick_4",
        "quick_merge_5": "./output_9_quick_merge_5",
        "merge_quick_5": "./output_9_merge_quick_5"
    }

    # 紀錄哪些資料點超時並需要預測
    missing_points = {
        "quick_merge_1": {"k_value": [], "predicted_time": []},
        "merge_quick_1": {"k_value": [], "predicted_time": []},
        "quick_merge_2": {"k_value": [], "predicted_time": []},
        "merge_quick_2": {"k_value": [], "predicted_time": []},
        "quick_merge_3": {"k_value": [], "predicted_time": []},
        "merge_quick_3": {"k_value": [], "predicted_time": []},
        "quick_merge_4": {"k_value": [], "predicted_time": []},
        "merge_quick_4": {"k_value": [], "predicted_time": []},
        "quick_merge_5": {"k_value": [], "predicted_time": []},
        "merge_quick_5": {"k_value": [], "predicted_time": []},
    }
    ...
    for s in range(1,6):
        ...
        for k in range(0, 21):  # 可調整範圍
            ...
            for name, executable in cpp_programs.items():
                ...
                success = run_cpp_program(executable, size, "third", k_value ,s_value, output_files[name], timeout=3000)
                if not success:
    ...
    for name, output_file in output_files.items():
        ...
        if model and missing_points[name]["k_value"]:
            for size in missing_points[name]["k_value"]:
        ...
        # 繪製圖表
    plot_graph(list(output_files.values()), list(cpp_programs.keys()), "graph_9.png", missing_points)
