...
def plot_graph(filenames, labels, output_image, missing_points):
    ...
    colors = ['#ff7f0e', '#2ca02c', '#d62728']  # 默認顏色循環
...
def main():
    ...
    output_files = {
        "merge_sort": "output_1_1_merge_sort_1",
        "quick_hoare": "output_1_1_quick_hoare_1",
        "counting_sort": "output_1_1_counting_sort_1"
    }

    # 紀錄哪些資料點超時並需要預測
    missing_points = {
        "merge_sort": {"size": [], "predicted_time": []},
        "quick_hoare": {"size": [], "predicted_time": []},
        "counting_sort": {"size": [], "predicted_time": []}
    }
    ...
    # 繪製圖表
    plot_graph(list(output_files.values()), list(cpp_programs.keys()), "grapg_1_1.png", missing_points)
