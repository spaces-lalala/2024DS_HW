...
def main():
    ...
    output_files = {
        "quick_lomuto": "./output_5_quick_lomuto",
        "quick_hoare": "./output_5_quick_hoare",
        "quick_3way": "./output_5_quick_3way"
    }
    ...
    # 繪製圖表
    plot_graph(list(output_files.values()), list(cpp_programs.keys()), "graph_5.png", missing_points)
