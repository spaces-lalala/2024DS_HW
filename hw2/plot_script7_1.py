...
def main():
    ...
    output_files = {
        "merge_sort": "output_7_1_merge_sort",
        "quick_hoare": "output_7_1_quick_hoare",
        "counting_sort": "output_7_1_counting_sort"
    }
    ...
    # 繪製圖表
    plot_graph(list(output_files.values()), list(cpp_programs.keys()), "graph_7_1.png", missing_points)
